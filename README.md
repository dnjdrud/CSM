...
**Env:** Apply `supabase/migrations/20250308000000_signup_approval.sql`. Deploy `send-approval-email` and set `RESEND_API_KEY`, `EMAIL_FROM` in Supabase secrets; set `NEXT_PUBLIC_APP_URL` (or `APP_URL`) in the app.
