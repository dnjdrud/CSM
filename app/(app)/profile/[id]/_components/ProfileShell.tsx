            ...
            <div className="flex items-center gap-2">
              ...
              {isOwnProfile && (
                <>
                  ...
                  <Link
                    href="/settings"
                    className="flex items-center justify-center w-8 h-8 rounded-xl border border-theme-border bg-theme-surface text-theme-muted hover:border-theme-primary/50 hover:text-theme-text transition-all"
                    aria-label="설정"
                  >
