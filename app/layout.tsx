  ...
  return (
    <html lang={initialLocale}>
      <body className="min-h-screen flex flex-col bg-theme-bg text-theme-text">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-theme-primary focus:text-black focus:rounded-md"
        >
