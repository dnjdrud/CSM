  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-10">
      ...
      <section className="mt-8">
        <h2 className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-3">전체 현황</h2>
        <div className="grid gap-4 sm:grid-cols-3">
          <Card>
            <CardContent>
              <p className="text-xs font-medium text-neutral-500">총 사용자</p>
              <p className="mt-1 text-2xl font-semibold text-gray-900">{stats.totalUsers.toLocaleString()}</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent>
              <p className="text-xs font-medium text-neutral-500">총 포스트</p>
              <p className="mt-1 text-2xl font-semibold text-gray-900">{stats.totalPosts.toLocaleString()}</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent>
              <p className="text-xs font-medium text-neutral-500">총 댓글</p>
              <p className="mt-1 text-2xl font-semibold text-gray-900">{stats.totalComments.toLocaleString()}</p>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="mt-6">
        <h2 className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-3">오늘 활동</h2>
        <div className="grid gap-4 sm:grid-cols-3">
          <Card>
            <CardContent>
          ...
          <Card>
            <CardContent>
              ...
              <p className="mt-1 text-2xl font-semibold text-gray-900">{stats.newPostsToday}</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent>
      ...
      <section className="mt-6">
        <h2 className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-3">최근 7일</h2>
        <div className="grid gap-4 sm:grid-cols-3">
          <Card>
            <CardContent>
              ...
              <p className="mt-0.5 text-xs text-gray-400">포스트·댓글·반응 기준</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent>
              ...
              <p className="mt-0.5 text-xs text-gray-400">Sentry 확인 필요</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent>
              ...
              <p className="mt-0.5 text-xs text-gray-400">Supabase Edge Function 로그</p>
            </CardContent>
          </Card>
        </div>
      </section>
